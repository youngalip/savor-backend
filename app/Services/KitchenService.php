...
{
    private const STATION_TYPE = 'kitchen';

    /**
     * Get daftar pesanan kitchen berdasarkan status
     */
    ...
    /**
     * Get semua pesanan kitchen (semua status)
     */
    ...
    public function startOrder(int $id): StationOrder
    {
        return DB::transaction(function () use ($id) {
            ...
            Log::info("Kitchen order {$id} started");
    ...
    public function completeOrder(int $id): StationOrder
    {
        return DB::transaction(function () use ($id) {
            ...
            Log::info("Kitchen order {$id} completed");
