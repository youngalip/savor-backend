...
class BarService
{
    private const STATION_TYPE = 'bar';

    /**
     * Get daftar pesanan bar berdasarkan status
     */
    ...
    /**
     * Get semua pesanan bar (semua status)
     */
    ...
    public function completeOrder(int $id): StationOrder
    {
        return DB::transaction(function () use ($id) {
            ...
            Log::info("Bar order {$id} completed");
